...
## ARIMA(0,1,2) with a constant, seasonal parameter and period = 12
...
```{r ARIMA fit}
bx_arima012_001_12 <- bx_ts %>% model(bx_arima012_001_12 = ARIMA(total_waste ~ 1 + 
                                                                   pdq(0,1,2) + 
                                                                   PDQ(0,0,1, period = 12)))
...
## ARIMA(0,1,1) with constant, MA() seasonal parameter and period = 12
...
## ARIMA(0,1,1) with constant, AR() seasonal parameter and period = 12
