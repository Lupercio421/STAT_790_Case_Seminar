...
```{r}
# bx_test_ts <- as_tsibble(bx_test, index = 'month', regular = FALSE)
bx_test_ts <- bx_test_ts %>% 
...
```
As we can see, we can not use the model fitted on the training set, onto the test set. I believe we will need to create a new model, using the parameters from the training models. 
