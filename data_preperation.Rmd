...
bx_total_waste_fit_seasonal <- bx_ts %>% 
  model(arima003 = ARIMA(total_waste ~ pdq(0,0,3)), # This model has a constant and the Seasonal MA(1) component is not included 
        ...
        arima003s12 = ARIMA(total_waste ~ 1+ pdq(0,0,3) + PDQ(0,0,12)), # This model has a constant and the Seasonal MA(12) component is included. 12 for the number of months
